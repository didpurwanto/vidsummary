...
%% Input file--------------------- Input video CNN feature ---------------------
...
for i=11 :totalVideo
    ...
    filename = strcat('D:\CNN_img\matlab\demo\feature_cnn_SumMe\fc7\',srcFiles(i).name);
...
% SumMe dataset
save(['D:\CNN_img\matlab\demo\ITQ_HamDis\SumMe\Bit_64\IT_100\pre_5\test_1\1_1024/' name '.mat'], 'HammDis_select');
