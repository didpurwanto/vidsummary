...
tic;
%% Input file
srcFiles = dir('D:\CNN_img\matlab\demo\darwin_SumMe\HammDist\pre_5\test_1\Bit64_It100_256\if\*.mat'); % SumMe
totalVideo = length(srcFiles);

% Hamming distance index
srcFiles_index = dir('D:\CNN_img\matlab\demo\ITQ_HamDis\SumMe\Bit_64\IT_100\pre_5\test_1\1_256\*.mat');
...
for j = test : totalVideo     % load the file
    ...
    filename = strcat('D:\CNN_img\matlab\demo\darwin_SumMe\HammDist\pre_5\test_1\Bit64_It100_256\if\',srcFiles(j).name);
    ...
    filename_index = strcat('D:\CNN_img\matlab\demo\ITQ_HamDis\SumMe\Bit_64\IT_100\pre_5\test_1\1_256\',srcFiles_index(j).name);
...
% % %     save(['D:\CNN_img\matlab\demo\darwin_vsumm\HammDist\pre_5\test_3\Bit64_It100_256\ma_Max_index/' name '.mat'], 'actual_frame_all');
    %%% SumMe dataset
    save(['D:\CNN_img\matlab\demo\darwin_SumMe\HammDist\pre_5\test_1\Bit64_It100_256\if_Max_index/' name '.mat'], 'actual_frame_all');
end
